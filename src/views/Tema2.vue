...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.ampliar.fondo-13.px-5
      .col-12
        .row.justify-content-center.mt-5
          .col-lg-5.col-md-8.col-sm-10.col-12(data-aos="fade-up")
    ...
    .row.justify-content-center.my-5
      ...
      .col-lg-8.col-md-12(data-aos="fade-up")
        p Es así como el 
          span.resaltado.text-bold conocimiento de las comunidades receptoras locales 
          span son un aporte al aprendizaje,  debido a que se convierten en actores y agentes que se involucran en el diseño y desarrollo de experiencias turísticas del destino, y son a su vez personas clave en la ejecución de actividades que se realizan durante las salidas de campo.
        p Es importante anotar que las salidas de campo son un componente de articulación que permiten  
          span.resaltado.text-bold aplicar en el territorio los conocimientos del guía en formación
          span , con el propósito de contribuir y reforzar sus habilidades y destrezas, y a la vez fortalecer la competencia técnica y laboral del programa de formación.
          .cajon.fondocuadrado1.p-4.fondo-4
            p.text-bold.mb-0 Por esa razón es importante vincular en las salidas de campo al guía en formación con las comunidades locales y, trabajar en equipo en el diseño y ejecución de las experiencias turísticas.
        p En la siguiente figura se muestran los agentes que participan en la cadena de valor de una salida de campo, es decir, el grupo de actores que se integran en esta actividad y que fomentan la economía de una región.
    .row.ampliar.fondo-14.px-5
      .col-12
        .titulo-sexto.color-acento-contenido(data-aos="fade-up")
          h5 Figura 2
          span  Cadena de valor de una salida de campo
